#ifndef IR_GLASSES_EVT_E6_F302_INTERFACE_H
#define IR_GLASSES_EVT_E6_F302_INTERFACE_H
#include <stdint.h>
#include <stddef.h>
/* Interface only: this is not a runnable firmware implementation.
 * Serialize each integer explicitly in little-endian order. */
#define EVT_E6_SYSCLK_HZ 48000000u
#define EVT_E6_APB1_CLOCK_HZ 24000000u
#define EVT_E6_APB2_CLOCK_HZ 48000000u
#define EVT_E6_TIMER_CLOCK_HZ 48000000u
#define EVT_E6_ADC_CLOCK_HZ 12000000u
#define EVT_E6_ADC_MAX_CODE 4095u
#define EVT_E6_DEFAULT_FPS 30u
#define EVT_E6_MIN_FPS 24u
#define EVT_E6_TIM2_ARR_30FPS 99999u
#define EVT_E6_TIM2_ARR_24FPS 124999u
#define EVT_E6_TIM1_ACTIVE_US 1000u
#define EVT_E6_DMA_CHANNELS_REQUIRED 3u
#define EVT_E6_TIM1_CCR_PRELOAD_ENABLED 0u
#define EVT_E6_TIM1_DMA_ON_UPDATE 0u
#define EVT_E6_TIM1_REPETITION_COUNT 0u
#define EVT_E6_TIM1_CH3_MAIN_ENABLED 0u
#define EVT_E6_TIM1_CH3N_POLARITY_INVERTED 0u
#define EVT_E6_PROTOCOL_VERSION 0xE7u
...
typedef struct {
    uint8_t protocol_version; /* offset 0: 0xE7 */
    ...
    uint32_t light_time_us;   /* offset 20: light-sample trigger time, modulo 2^32 */
    uint16_t dark_a;          /* offset 24, 0..4095 */
    uint16_t dark_b;          /* offset 26, 0..4095 */
    uint16_t light_a;         /* offset 28, 0..4095 */
    uint16_t light_b;         /* offset 30, 0..4095 */
